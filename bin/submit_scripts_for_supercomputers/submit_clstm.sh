...
#module purge; module load K80 cuda/7.5 mkl/2017.0.098 CUDNN/5.1.3 python/3.5.2_ML
...
python /gpfs/home/bsc19/bsc19277/contextualLSTM/src/lstm/clstm.py \
        ...
        --model small \
        --use_fp16 True \
        --word_to_id_path /gpfs/home/bsc19/bsc19277/contextualLSTM/models/eos/word2id_" > job
